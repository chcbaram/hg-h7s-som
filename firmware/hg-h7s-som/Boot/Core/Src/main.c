...
int main(void)
{
  ...
  SET_BIT(XSPIM->CR, XSPIM_CR_CSSEL_OVR_O1); /* XSPI1 NCS2로 설정*/
  CLEAR_BIT(XSPIM->CR, XSPIM_CR_CSSEL_OVR_O2); /* XSPI2 는 NCS1로 설정 */
...
static void MX_XSPI1_Init(void)
{
  ...
  hxspi1.Init.MemorySelect = HAL_XSPI_CSSEL_NCS2;
